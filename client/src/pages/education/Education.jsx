  ...
  return (
    <>
      <div className="container education" id="education">
        <h2 className="col-12 mt-3 text-center text-uppercase">Education</h2>
        <hr />
        <VerticalTimeline>
          <VerticalTimelineElement
            ...
            icon={<MdSchool />}
          >
            <h3 className="vertical-timeline-element-title">BEngr</h3>
            <h4 className="vertical-timeline-element-subtitle">UNN, Nigeria</h4>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
            contentStyle={{ background: "white", color: "black" }}
          ...
          >
            ...
            <h4 className="vertical-timeline-element-subtitle">SOLOLEARN</h4>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
            contentStyle={{ background: "white", color: "black" }}
